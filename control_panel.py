...
def main():
    ...
    parser.add_argument('--announcer-wizard', action='store_true', help="Launch interactive Discord announcer menu")
    ...
    if args.announcer_wizard:
        announcer.interactive_menu()
        return
