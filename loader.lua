...
local SCRIPT_REGISTRY = {
    ...
    -- Pickaxe Tycoon Full Mappings
    [73814003954154] = {
        Name = "Pickaxe Tycoon",
        Url = "https://eccohub.xyz/products/pickaxe_tycoon.lua",
        Fallback = "http://127.0.0.1:8999/products/pickaxe_tycoon.lua"
    },
    [10081194651] = {
        Name = "Pickaxe Tycoon",
        Url = "https://eccohub.xyz/products/pickaxe_tycoon.lua",
    ...
    -- Survive Zombie Arena Full Mappings
    [114204398207377] = {
        Name = "Survive Zombie Arena",
        Url = "https://eccohub.xyz/products/survive_zombie_arena.lua",
        Fallback = "http://127.0.0.1:8999/products/survive_zombie_arena.lua"
    },
    [9348272796] = {
        Name = "Survive Zombie Arena",
        Url = "https://eccohub.xyz/products/survive_zombie_arena.lua",
    ...
    -- Axe RNG Full Mappings
    [121863161094252] = {
        Name = "Axe RNG",
        Url = "https://eccohub.xyz/products/axe_rng.lua",
        Fallback = "http://127.0.0.1:8999/products/axe_rng.lua"
    },
    [10241922839] = {
        Name = "Axe RNG",
        Url = "https://eccohub.xyz/products/axe_rng.lua",
    ...
    ["DEFAULT"] = {
        Name = "Ecco Hub Universal",
        Url = "https://raw.githubusercontent.com/eridtpdiscord-cloud/ecco-loader/main/universal.lua",
        Fallback = "http://127.0.0.1:8999/universal.lua"
    }
}
...
task.spawn(function()
    ...
    addLog("Discord: https://discord.gg/hN9QpA3HA | Platform: https://eccohub.xyz", Color3.fromRGB(160, 160, 160))
    addLog("", Color3.fromRGB(204, 204, 204))
    task.wait(0.2)
